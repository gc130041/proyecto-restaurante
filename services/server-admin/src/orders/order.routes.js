...
import { createOrder, updateItemStatus, updateOrderStatus, getOrders, getOrdersByTable } from "./order.controller.js";
...
/**
 * @route /api/v1/orders/:orderId/item/:itemId/status
